...
class CalibrationWindow(QDialog):
    def __init__(self, parent=None):
        ...
        self.steps = [
            ...
            ("Prepare for Power Sphere Grasp", "./images/power_sphere.png", 2), # 1
            ("Power Sphere Grasp", "./images/power_sphere.png", 2), # 2
            ("Relax your hand", "./images/rest.png", 2), # 3
            ("Prepare for Large Diameter Grasp", "./images/large_diameter.png", 2), # 4
    ...
    def update_timer(self):
        ...
        if self.time_left >= 0:
            ...
            # Grasp
            if self.current_step == 2 or self.current_step == 5:
                if self.rep_count <= 10:
                    self.rep_count -= 1
                    self.time_left = self.steps[self.current_step][2]

            # Relax your hand
            if (self.current_step == 3 or self.current_step == 6) and self.rep_count <= 10:  # Cycle through 10 reps
                self.current_step -= 1
            else:
                self.current_step += 1
